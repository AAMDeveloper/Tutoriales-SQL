...
INSERT INTO Producto VALUES (9, 'LIMON', 'FRUTA', 'UNIDAD');

SELECT * FROM Producto;

SELECT pro_nombre 
FROM Producto 
WHERE pro_tipo = 'FRUTA'
ORDER BY pro_nombre DESC

UPDATE Producto SET pro_nombre = 'PERA' WHERE pro_cod = 9;

DELETE FROM Producto WHERE pro_cod = 9;

CREATE TABLE Receta
	(rec_cod INTEGER PRIMARY KEY, 
	 rec_nombre VARCHAR(20), 				
	 rec_tipo VARCHAR(10));

INSERT INTO Receta VALUES (1, 'QUEQUE', 'PASTELERIA');
INSERT INTO Receta VALUES (2, 'SPAGUETTI','PASTA');
INSERT INTO Receta VALUES (3,'TORTILLA VEG','VEGETARIA');
...
-- Muestre el nombre de las recetas que utilizan el tipo cereal o lacteos.

SELECT DISTINCT REC_NOMBRE 
